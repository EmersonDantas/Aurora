...
urlpatterns = [
    ...
    path('subject/editsubject/', editSubject, name='editSubject'),
    path('subject/deletesubject/', deleteSubject, name='deleteSubject'),
    path('subject/newsubject/', newSubject, name='newSubject'),
]